...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Match', path: '/matches', entity: 'match', service: AccessServiceEnum.PROJECT, icon: FiPlayCircle },
    { name: 'Puzzle', path: '/puzzles', entity: 'puzzle', service: AccessServiceEnum.PROJECT, icon: FiHelpCircle },
    {
      name: 'Strategy Guide',
      path: '/strategy-guides',
